...
#define SENSOR1_BUS_PIN 22
#define SENSOR2_BUS_PIN 24
#define SENSOR3_BUS_PIN 26

#define SENSOR4_BUS_PIN 30
#define SENSOR5_BUS_PIN 32
...
float graficoTA[CTA];
int colorTermA1=Blue, colorTermA2=Blue, colorGrafA=Blue;
...
int colorTermR1=Blue, colorTermR2=Blue, colorGrafTT1=Blue, colorGrafTT2=Red,colorGrafTTN=Green;
