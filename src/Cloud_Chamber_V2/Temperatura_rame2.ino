void temperaturarame2()
{
  ...
  {
    tft.drawLine(i*passo+X0TR,Y0TR-(float)(((float)((grafico2[i])*altGrafTR)/hgraftemp)),i*passo+X0TR-passo,Y0TR-(float)(((float)((grafico2[i-1])*altGrafTR)/hgraftemp)),colorGrafTT2);
  }
  ...
  do
  {
    ...
    {  
      ...
      {
        tft.drawLine((contvR-1)*passo+X0TR,Y0TR-(float)(((float)((grafico2[contvR-1])*altGrafTR)/hgraftemp)),(contvR-2)*passo+X0TR,Y0TR-(float)(((float)((grafico2[contvR-2])*altGrafTR)/hgraftemp)),colorGrafTT2);
      }
